...
class SortedCollection(object):
    ...
    directly. It supports key functions like those use in sorted(), min(), and
    max(). The result of the key function call is saved so that keys can be
    ...
    so that you can assign a new key function (triggering an automatic
    re-sort).

...
These reservations do overlap, but to know that it would be necessary to compare
each new reservation with the existing reservation. This is not only expensive,
but it also does not ensure that no reservations overlap if reservations are
added at the same time in a multiuser environment. 
